        ...
        <form onSubmit={(e) => props.loginSubmit(e, {email: Email, password: Password}, errors)} autoComplete="off">
            <VStack>
                ...
                <FormControl id='password'>
                    ...
                    <InputGroup>
                        <Input type={show ? 'text' : 'password'} placeholder='Password' size='lg' bg='white' borderRadius='18px' mb='1rem' focusBorderColor='focusRed' onChange={(e) => setPassword(e.target.value)}/>
